...
describe("Favorite", () => {
  ...
  beforeEach((done) => {
    // store user, topic, post, favorite
    this.user;
    this.topic;
    this.post;
    this.favorite;

    // clear database and create the objects above
  ...
  describe("#create()", () => {
    ...
    it("should create a favorite for a post on a user", (done) => {
      ...
      .then((favorite) => {
        ...
        // ensure the favorite is created successfully
    ...
    // don't create a favorite without a userId or postId
