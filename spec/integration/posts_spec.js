...
describe("routes : posts", () => {
  ...
  // create a user, topic, and post for that topic
  beforeEach((done) => {
     this.topic;
     this.post;
     this.user;
  ...
  // end guest user CRUD tests

  // admin or owner user context tests
  describe("owner or admin user performing CRUD actions for posts", () => {
  ...
  // end owner/admin user context tests
